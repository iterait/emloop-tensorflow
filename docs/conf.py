...
version = '.'.join(pkg_resources.get_distribution("cxflow_tensorflow").version.split('.')[:2])
# The full version, including alpha/beta/rc tags.
release = pkg_resources.get_distribution("cxflow_tensorflow").version
...
htmlhelp_basename = 'cxflow-tensorflowdoc'
...
man_pages = [
    (master_doc, 'cxflow-tensorflow', 'cxflow-tensorflow Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cxflow-tensorflow', 'cxflow-tensorflow Documentation',
     author, 'cxflow-tensorflow', 'One line description of project.',
     'Miscellaneous'),
]
